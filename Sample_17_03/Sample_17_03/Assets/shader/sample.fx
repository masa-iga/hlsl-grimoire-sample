...
void chs(inout RayPayload payload, in BuiltInTriangleIntersectionAttributes attribs)
{
    ...
    // step-4 シャドウレイを飛ばす
    {
        ...
        const uint multiplierFo5rGeometryContributionToHitGroupIndex = 0;
        ...
        TraceRay(
            ...
            multiplierFo5rGeometryContributionToHitGroupIndex,
            missShaderIndex,
            ray,
            payload
        );
